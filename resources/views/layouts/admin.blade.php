...
<html lang="en">
  <head>
    ...
    <!-- <link rel="stylesheet" id="css-theme" href="assets-admin/css/themes/flat.min.css"> -->
    <!-- END Stylesheets -->
  </head>
  <body>
    <!-- Page Container -->
      ...
      <aside id="side-overlay">
        ...
        <div class="content-header">
          ...
          <a class="img-link me-2" href="be_pages_generic_profile.html">
            <img class="img-avatar img-avatar32" src="{{asset('assets-admin/media/avatars/avatar15.jpg')}}" alt="">
          </a>
          <!-- END User Avatar -->
              ...
              <ul class="nav-users">
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="{{asset('assets-admin/media/avatars/avatar4.jpg')}}" alt="">
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="{{asset('assets-admin/media/avatars/avatar15.jpg')}}" alt="">
                    <i class="fa fa-circle text-success"></i>
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="{{asset('assets-admin/media/avatars/avatar6.jpg')}}" alt="">
                ...
                <li>
                  <a href="be_pages_generic_profile.html">
                    <img class="img-avatar" src="{{asset('assets-admin/media/avatars/avatar12.jpg')}}" alt="">
              ...
              <div class="dropdown-menu dropdown-menu-lg p-0" aria-labelledby="page-header-themes-dropdown">
                ...
                <div class="p-3">
                  <div class="row g-0 text-center">
                    ...
                    <div class="col-2">
                      <a class="text-elegance" data-toggle="theme" data-theme="{{asset('assets-admin/css/themes/elegance.min.css')}}" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                    <div class="col-2">
                      <a class="text-pulse" data-toggle="theme" data-theme="{{asset('assets-admin/css/themes/pulse.min.css')}}" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                    <div class="col-2">
                      <a class="text-flat" data-toggle="theme" data-theme="{{asset('assets-admin/css/themes/flat.min.css')}}" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                    <div class="col-2">
                      <a class="text-corporate" data-toggle="theme" data-theme="{{asset('assets-admin/css/themes/corporate.min.css')}}" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>
                      </a>
                    </div>
                    <div class="col-2">
                      <a class="text-earth" data-toggle="theme" data-theme="{{asset('assets-admin/css/themes/earth.min.css')}}" href="javascript:void(0)">
                        <i class="fa fa-2x fa-circle"></i>{{asset('')}}
                      </a>
                    </div>
                  </div>
                </div>
    ...
    <!--
        ...
        webpack is putting everything together at assets-admin/_js/main/app.js
    -->
    <script src="assets-admin/js/codebase.app.min.js"></script>
